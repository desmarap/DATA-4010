...
# Find the tree species that do not have many data points, in this case,e less than 10
...
# We can change the dataset to remove any feature to check the drop ion accuracy
